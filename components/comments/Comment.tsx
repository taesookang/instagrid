...
export const Comment: React.FC<Props> = ({ comment, modalOpen, setModalOpen, setSelectedComment }) => {
    ...
    return (
        <div className="comment flex min-h-fit w-full mt-4">
          <div className="relative min-w-[32px] min-h-[32px] w-8 h-8 overflow-hidden rounded-full mr-4">
            <Image src={comment.userPhotoUrl!} layout="fill" />
          </div>
          <div className="flex flex-col w-full">
            ...
            <div className="mt-2 mb-1 flex items-center min-h-[24px] h-fit">
              ...
              <div className="comment__menu ml-2 cursor-pointer"
                onClick={() => {setModalOpen(true); setSelectedComment(comment.id)}}
              >
